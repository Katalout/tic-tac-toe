        ...
        if (board.placeToken(row, column, activePlayer.token)) {
            ...
            function checkWin() {
                ...
                function gameOver(winner) {
                    ...
                    else { logger = `// Winner is ${winner.name} (${winner.token})!`; };
...
function UIcontroller() {
    ...
    function updateScreen() {
      ...
      <path class="first"
        ...
        fill="none" stroke-width="8" stroke="black" stroke-linecap="round" stroke-dasharray="0 0"
      ...
      <path class="second"
        ...
        fill="none" stroke-width="8" stroke="black" stroke-linecap="round"
      ...
      <path
        ...
        fill="none" stroke-width="10" stroke="black"></path>
    </svg>`;
